...
const navItems = [
  { href: '#problem', label: 'The Problem', icon: '📉' },
  { href: '#solution', label: 'The Solution', icon: '✅' },
  { href: '#roi', label: 'The ROI', icon: '📈' },
  { href: '#blueprint', label: 'Platform Blueprint', icon: '🏗' },
];
          ...
          {navItems.map(({ href, label, icon }) => (
            <a
              ...
              className={`nav-item flex items-center space-x-2 ${
                activeSection === href ? 'text-accent border-b-2 border-accent' : 'border-b-2 border-transparent'
